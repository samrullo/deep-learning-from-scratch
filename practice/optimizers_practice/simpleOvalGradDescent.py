...
from practice.optimizers import SGD
from practice.simple_layers import SimpleOvalSquareFuncLayer
...
for it in range(iters_num):
    simpleLayer = SimpleOvalSquareFuncLayer(params['x1'], params['x2'])
...
simpleLayer = SimpleOvalSquareFuncLayer(mx1, mx2)
